...
function setup() {
  ...
  //move it upwards.
  space = createSprite(0, windowHeight - windowHeight, windowWidth, windowHeight);
  ...
  next_but = createSprite(windowWidth / 2, windowHeight - 200, 30, 30);
  next_but.scale = 0.6;
  ...
  win1.position(windowWidth - 1500, windowHeight - 600);
  ...
  press_2.position(windowWidth - 1100, windowHeight - 400);
